...
export default function WhatIDo() {
  ...
  return (
    <section id="what-i-do" className="relative p-4 sm:p-10 lg:p-12 overflow-hidden">
      <div className="relative z-10 w-full">
        ...
        <div className="flex items-center justify-between mb-8 pb-4 border-b border-white/[0.05]">
          ...
          <button 
            ...
            className="text-[13px] sm:text-xs font-bold text-neutral-500 hover:text-neutral-300 uppercase tracking-widest transition-colors duration-300 cursor-pointer"
          >
            View Stack
          </button>
        </div>
          ...
          {siteContent.whatIDo.map((service, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group p-[1px] rounded-2xl bg-gradient-to-b from-white/[0.06] to-transparent border border-white/[0.04] lg:border-none shadow-none lg:shadow-lg lg:hover:scale-[1.02] transition-all duration-300 flex"
              >
                <div className={`p-6 w-full bg-[#07070a] lg:bg-[#050508]/85 rounded-[calc(1.2rem-1px)] lg:border ${style.borderClass} lg:${style.glowClass} flex flex-col justify-between transition-colors duration-300 gap-4 lg:gap-0`}>
                  <div>
                    ...
                    <div className="flex items-center gap-3.5 mb-4">
                      ...
                      <h3 className="font-display text-[16px] sm:text-base lg:md:text-base font-bold text-white tracking-tight leading-snug">
                        {service.title}
                      </h3>
                    </div>
                    
                    <p className="text-neutral-400 text-[14.5px] md:text-sm leading-relaxed font-sans font-medium mb-4">
                      {service.description}
                    </p>
                  </div>
                  ...
                  {service.bulletPoints && (
                    <div className="flex flex-wrap gap-2 lg:gap-1 mt-auto pt-3 border-t border-white/[0.04]">
                      {service.bulletPoints.map((bp, bpIdx) => (
                        <span
                          key={bp}
                          className={`px-2.5 py-1.5 rounded bg-white/[0.01] lg:bg-white/[0.02] border border-white/[0.03] lg:border-white/[0.04] text-[13.5px] md:text-xs font-sans font-semibold text-neutral-400 lg:text-neutral-500 lg:hover:text-neutral-300 transition-colors duration-300 ${
