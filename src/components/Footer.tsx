...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-white/[0.04] py-8 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
        
        {/* Left Side: Brand Signature inline metadata */}
        <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 text-[11px] md:text-xs text-neutral-500 font-bold uppercase tracking-wider text-center md:text-left leading-relaxed">
        ...
        <div className="text-[11px] md:text-xs text-neutral-600 font-semibold tracking-wider uppercase shrink-0">
